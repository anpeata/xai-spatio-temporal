...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{tcolorbox}[enhanced,boxrule=1pt,arc=2pt,colback=clight,colframe=cmid,
      title=Submission (June), fonttitle=\bfseries\small\color{white},
    ...
    \begin{itemize}\setlength\itemsep{2pt}
      \item \textbf{June 8}: first report draft (v0.1).
      \item \textbf{June 22}: admin check + day-count review.
      \item \textbf{June 26}: evaluation form deadline (lab supervisors).
      \item \textbf{June 26}: my target to submit the report.
      \item \textbf{June 27 (midnight AoE)}: school deadline.
    \end{itemize}
  \end{tcolorbox}
  \column{0.44\textwidth}
  \begin{tcolorbox}[enhanced,boxrule=1pt,arc=2pt,colback=clight,colframe=cbg2,
      title=Defense (July), fonttitle=\bfseries\small\color{white},
      attach boxed title to top left={yshift=-2pt,xshift=4pt},
      boxed title style={colback=cbg2,arc=2pt,boxrule=0pt},top=4pt,bottom=4pt]
    \footnotesize
    \begin{itemize}\setlength\itemsep{2pt}
      \item \textbf{July 2, 11:45}: upload slides (\,$\ge$24h before).
      \item \textbf{July 3, 11:45}: defense in person.
      \item Slides: \textbf{15 minutes} (aim \~1 slide per minute).
