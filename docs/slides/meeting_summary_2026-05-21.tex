...
\begin{columns}[T,onlytextwidth]
	...
	\column{0.25\textwidth}
	\statcard{7}{Seeds used}{Stability + fidelity}
	\column{0.25\textwidth}
	\statcard{3 baselines}{Core methods}{KMeans, ExKMC, AE+KMeans}
	\column{0.25\textwidth}
	\statcard{EDA done}{Picoclimate}{Figures + CSV summary}
\end{columns}
\vspace{0.25cm}
\begin{itemize}\footnotesize\setlength\itemsep{2pt}
	\item All numbers and figures are from archived outputs and notebook runs.
\end{itemize}
\end{frame}
