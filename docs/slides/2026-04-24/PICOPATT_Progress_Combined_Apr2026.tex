...
\subtitle{Combined Progress Review --- April 2026}
\author{An Pham}
...
\begin{columns}[T]
  ...
  \begin{tcolorbox}[enhanced,boxrule=1pt,arc=2pt,colback=clight,colframe=cmid,
    ...
    \begin{itemize}\setlength\itemsep{2pt}
      ...
      \item Measure stability with Jaccard overlap of top SHAP features across 5+ seeds.
  ...
  \begin{tcolorbox}[enhanced,boxrule=1pt,arc=2pt,colback=clight,colframe=cteal,
    ...
    \centering
    {\color{ctext}\bfseries\large 1--2 papers}\\[4pt]
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{tcolorbox}[enhanced,boxrule=1pt,arc=2pt,colback=clight,colframe=cmid,
    ...
    \footnotesize\begin{itemize}\setlength\itemsep{1pt}
      ...
      \item Literature review draft \checkmark
    \end{itemize}
  \end{tcolorbox}
  \column{0.48\textwidth}
...
\begin{tcolorbox}[enhanced,boxrule=1pt,arc=2pt,colback=cdark!4,colframe=cdark,
  ...
  \begin{tabular}{@{}p{2.2cm}p{2.8cm}p{2.8cm}@{}}
    \textbf{Mar 9} & Kickoff & Literature review starts \\
    \textbf{Mar 20} & Data structure & Writing started \\
    \textbf{Apr 9} & Pipeline architecture & Shapelet / clustering path drawn \\
    \textbf{Apr 17--23} & Implementation sprint & New baselines benchmarked \\
...
\begin{columns}[T]
  ...
  \begin{itemize}\setlength\itemsep{1pt}
    ...
    \item Explanation stability: 7 seeds, Jaccard top-feature overlap metric
...
\begin{columns}[T,onlytextwidth]
  \column{0.58\textwidth}
  \centering
  \figureplaceholder{0.92\linewidth}{2.4cm}
  \column{0.38\textwidth}
  \begin{block}{What this slide should show}
    \begin{itemize}
      \item Surrogate CV fidelity band
      \item Top-5 SHAP overlap across 7 seeds
