...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{block}{Interpretation}
    \begin{itemize}
      ...
      \item Latent space improves clustering in the quick test (silhouette 0.154 $\to$ 0.229)
...
\begin{columns}[T,onlytextwidth]
  ...
  \begin{block}{Interpretation}
    \begin{itemize}
      ...
      \item Spatial density is now part of the benchmarking story, even though the quick test still favors KMeans
